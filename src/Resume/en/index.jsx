const en = {
  ...
  'proficiencies': [
    ...
    {'title': 'And...', 'description': 'Skipping over Go, Java, and some others off the beaten path. If this list needs expansion, I can quickly learn and adapt in a new environment.'},
  ],
